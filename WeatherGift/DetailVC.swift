...
//  WeatherGift
//
//  Created by Cameron Arrigo on 3/10/19.
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func handleLocationAuthorizationStatus(status: CLAuthorizationStatus) {
        ...
        case .denied:
            showAlertToPrivacySettings(title: "User has not authorized location services", message: "Select settings below to open device settings and change location settings for this app.")
        case .restricted:
            showAlert(title: "Location services denies", message: "It may be that parental controls are restricting location use in this app.")
        }
    }
    ...
    func showAlertToPrivacySettings(title: String, message: String) {
        ...
        let settingsAction = UIAlertAction(title: "Settings", style: .default) { value in UIApplication.shared.open(settingsURL, options: [:], completionHandler: nil)
        }
